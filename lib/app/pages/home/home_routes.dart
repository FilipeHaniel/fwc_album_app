...
import 'package:fwc_album_app/app/repositories/auth/user/user_repository_impl.dart';

class HomeRoutes extends FlutterGetItPageRoute {
  const HomeRoutes({super.key});

  @override
  List<Bind<Object>> get bindings => [
        Bind.lazySingleton<UserRepository>(
            (i) => UserRepositoryImpl(customDio: i())),
